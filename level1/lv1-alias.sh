...
# DATETIME:2017-01-10T23:37:52.783Z
DCN=lv1
alias dc='docker-compose -p lv1 -f lv1-peers.yml'
alias dcup='dc stop && dc rm && dc up -d && dc scale bvp1=3'
alias vp0='docker exec -i -t lv1_bvp0_1'
alias vp1='docker exec -i -t lv1_bvp1_1'
alias vp2='docker exec -i -t lv1_bvp1_2'
alias vp3='docker exec -i -t lv1_bvp1_3'
