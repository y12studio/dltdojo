...
Dltdocker.ServiceArgs = function(argv) {
    ...
    if (argv.network) {
        ...
        switch (argv.serviceName) {
            case 'btc':
                docker.getService('btcboot').remove(DU.callback)
                docker.getService('btcpeer').remove(DU.callback)
                break;
            case 'eth':
                docker.getService('ethboot').remove(DU.callback)
                docker.getService('ethpeer').remove(DU.callback)
                break;
            default:
