...
Dltdocker.prototype.bitcoinboot = function(argv){
...
Dltdocker.prototype.bitcoinpeer = function(argv) {
...
Dltdocker.Args = function(argv) {
    ...
    if (argv.cmd1 && argv.cmd2 && argv.id) {
        if (argv.cmd1 == 'service') {
            if (argv.cmd2 == 'create') {
                argv.dojo = argv.dojo || {}
                switch (argv.id) {
                    case 'dltdojo':
